...
int socket_getchar(int );

PLI_INT32 socket_getchar_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
  int arg_1;
  int vpi_result;
  ...
  vpi_result = socket_getchar(arg_1);
...
PLI_INT32 socket_getchar_sizetf(PLI_BYTE8 *user_data)
{
  return 32u;
}
...
void socket_getchar_vpi_register()
{
  ...
  tf_data.tfname = "$socket_getchar";
  tf_data.calltf = socket_getchar_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = socket_getchar_sizetf;
  tf_data.user_data = "$socket_getchar";
