...
help:
	...
	@echo '    make  compile_all_ip		Generate BSCore, BSDebug, CLINT, PLIC RTL'
	...
	@echo '    make  compile_sim_rtos	Generate Sim SoC that run FreeRTOS'
	@echo ''
	...
	@echo '   NOTE: needs CATALYST_INSTALL to point to top-level of the release'
...
CATALYST_DIRS = $(CATALYST_REPO)/src/bsv
...
# Directory where Catalyst auto-generated BSV files are created
CATALYST_GEN_DIRS = ./src/bsv

BSC_PATH = -p $(CATALYST_GEN_DIRS):$(CORE_DIRS):$(IP_DIRS):$(CATALYST_DIRS):$(FABRIC_DIRS):$(TESTBENCH_DIRS):+:%/Libraries/AMBA_TLM3/TLM3:%/Libraries/AMBA_TLM3/Axi:%/Libraries/AMBA_TLM3/Axi4:%/Libraries/Bus
...
CLINT_TOP_FILE   = $(CLINT_REPO)/src/CLINT_$(FABRIC).bsv
CLINT_TOP_MODULE = mkCLINT_$(FABRIC)

PLIC_TOP_FILE   = $(PLIC_REPO)/src/PLIC_$(FABRIC)_16_1_7.bsv
...
compile_dm: build_dir  DM_RTL
	...
	for f in FIFO2.v FIFO20.v FIFO1.v SyncFIFOLevel.v ASSIGN1.v ResetInverter.v SyncHandshake.v SyncWire.v SyncResetA.v MakeResetA.v; do cp $(SRC_BSC_LIB_DIR)/$$f DM_RTL/; done
...
compile_all_ip: compile_core compile_dm compile_clint compile_plic
...
.PHONY: compile_sim_rtos
compile_sim_rtos: build_dir CFG_DIR Sim_RTOS_RTL
	@echo '-------------------------'
