...
help:
	@echo '------------------------'
	@echo 'MCU Makefile for configurations without Debug Module or TCM Loader'
...
compile_sim_rtos: build_dir CFG_DIR Sim_RTOS_RTL
	...
	bsc -u -elab -verilog -vdir Sim_RTOS_RTL $(RTL_BDIRS) $(BSC_COMPILATION_FLAGS) $(BSC_PATH) $(SIM_TOP_FILE)
