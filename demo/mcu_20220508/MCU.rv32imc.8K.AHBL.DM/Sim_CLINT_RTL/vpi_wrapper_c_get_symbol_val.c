 ...
 * $imported_c_get_symbol_val call=c_get_symbol_val_calltf size=32 acc=rw:%TASK
 * 
 * For a Verilog simulator which requires a .sft file, use the following entry:
 * $imported_c_get_symbol_val vpiSysFuncSized 32 unsigned
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
unsigned int c_get_symbol_val(char *);
...
/* sft: $imported_c_get_symbol_val vpiSysFuncSized 32 unsigned */

/* tab: $imported_c_get_symbol_val call=c_get_symbol_val_calltf size=32 acc=rw:%TASK */
