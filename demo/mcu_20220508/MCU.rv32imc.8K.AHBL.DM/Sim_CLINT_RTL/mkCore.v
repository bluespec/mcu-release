...
module mkCore(CLK,
  ...
  assign WILL_FIRE_RL_dm_stub_rl_sbus_rsp =
	     CAN_FIRE_RL_dm_stub_rl_sbus_rsp &&
	     !WILL_FIRE_RL_dm_stub_rl_gpr_rsp ;
  ...
  assign CAN_FIRE_RL_dm_stub_rl_gpr_rsp =
	     cpu$RDY_debug_hart_gpr_mem_server_response_get &&
	     dm_stub_ff_dm_sys_rsp$FULL_N ;
  assign WILL_FIRE_RL_dm_stub_rl_gpr_rsp = CAN_FIRE_RL_dm_stub_rl_gpr_rsp ;
  ...
  assign cpu$EN_dbg_server_response_get = WILL_FIRE_RL_dm_stub_rl_sbus_rsp ;
  ...
  begin
    ...
    v__h810 = v__h816 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%06d:[D]:%m.rl_cpu_hart0_reset_complete", v__h810);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h697 = v__h703 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%06d:[D]:%m.rl_cpu_hart0_reset_from_soc_start", v__h697);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1188 = v__h1194 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dm_stub_rl_rst_req)
	$display("%06d:[D]:%m.rl_cpu_hart0_reset_from_dm_start", v__h1188);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dm_stub_rl_rst_rsp)
	$display("%06d:[D]:%m.rl_cpu_hart0_reset_complete", v__h2056);
  end
  // synopsys translate_on
endmodule  // mkCore
