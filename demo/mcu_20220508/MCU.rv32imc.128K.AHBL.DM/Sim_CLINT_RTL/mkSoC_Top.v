...
module mkSoC_Top(dmi_reset,
  ...
  wire [31 : 0] clint$fabric_HADDR, clint$fabric_HRDATA, clint$fabric_HWDATA;
  wire [3 : 0] clint$fabric_HPROT;
  wire [2 : 0] clint$fabric_HBURST, clint$fabric_HSIZE;
  wire [1 : 0] clint$fabric_HTRANS;
  wire clint$fabric_HMASTLOCK,
       clint$fabric_HREADY,
       clint$fabric_HREADYOUT,
       clint$fabric_HRESP,
       clint$fabric_HSEL,
       clint$fabric_HWRITE,
       clint$sw_interrupt_pending,
  ...
  // submodule clint
  // NOTE: The Core Level Interrupt Device (CLINT)
  mkCLINT_AHBL clint(.CLK(CLK),
		     .RST_N(RST_N),
		     .fabric_HADDR(clint$fabric_HADDR),
		     .fabric_HBURST(clint$fabric_HBURST),
		     .fabric_HMASTLOCK(clint$fabric_HMASTLOCK),
		     .fabric_HPROT(clint$fabric_HPROT),
		     .fabric_HREADY(clint$fabric_HREADY),
		     .fabric_HSEL(clint$fabric_HSEL),
		     .fabric_HSIZE(clint$fabric_HSIZE),
		     .fabric_HTRANS(clint$fabric_HTRANS),
		     .fabric_HWDATA(clint$fabric_HWDATA),
		     .fabric_HWRITE(clint$fabric_HWRITE),
		     .fabric_HRDATA(clint$fabric_HRDATA),
		     .fabric_HREADYOUT(clint$fabric_HREADYOUT),
		     .fabric_HRESP(clint$fabric_HRESP),
		     .timer_interrupt_pending(clint$timer_interrupt_pending),
		     .sw_interrupt_pending(clint$sw_interrupt_pending));
  ...
  // submodule clint
  assign clint$fabric_HADDR = core$master1_HADDR ;
  assign clint$fabric_HBURST = core$master1_HBURST ;
  assign clint$fabric_HMASTLOCK = core$master1_HMASTLOCK ;
  assign clint$fabric_HPROT = core$master1_HPROT ;
  assign clint$fabric_HREADY = 1'd1 ;
  assign clint$fabric_HSEL = 1'd1 ;
  assign clint$fabric_HSIZE = core$master1_HSIZE ;
  assign clint$fabric_HTRANS = core$master1_HTRANS ;
  assign clint$fabric_HWDATA = core$master1_HWDATA ;
  assign clint$fabric_HWRITE = core$master1_HWRITE ;
  ...
  assign core$master1_HRDATA = clint$fabric_HRDATA ;
  assign core$master1_HREADY = clint$fabric_HREADYOUT ;
  assign core$master1_HRESP = clint$fabric_HRESP ;
  ...
  assign core$sw_interrupt = clint$sw_interrupt_pending ;
  assign core$timer_interrupt = clint$timer_interrupt_pending ;
  ...
  begin
    ...
    v__h2210 = v__h2216 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d:%m.rl_reset_start_initial ...", v__h2210);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2281 = v__h2287 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d:%m.rl_reset_complete_initial", v__h2281);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
