...
$ ./run_synth.sh -c 10.0 -t mkBSCore -f $MCU_INSTALL/MCU.rv32imc.64K.AHBL.DM/Core_RTL -j 4 
```
...
$ ./run_synth.sh -c 20.0 -t mkBSCore -f $MCU_INSTALL/MCU.rv32ic.64K.AHBL.DM/Core_RTL
```
