...
module mkBSCore(CLK,
  ...
  wire [31 : 0] a_out_araddr__h5103,
		...
		y__h5210,
		y__h5211;
  wire [7 : 0] x__h4400, x__h4907, x__h5394, x__h5613;
  wire [1 : 0] wrr_bresp__h2016;
  ...
  // register deburstr_rg_last_beat_raddr
  assign deburstr_rg_last_beat_raddr$D_IN = a_out_araddr__h5103 ;
  assign deburstr_rg_last_beat_raddr$EN =
	     CAN_FIRE_RL_deburstr_rl_rd_xaction_master_to_slave ;

  // register deburstr_rg_last_beat_waddr
  assign deburstr_rg_last_beat_waddr$D_IN = a_out_awaddr__h4019 ;
  ...
  assign loader_adapter_slave_xactor_f_wr_resp$D_IN =
	     { loader_adapter_f_awid$D_OUT, wrr_bresp__h2016 } ;
  ...
  assign a_out_awaddr__h4019 =
		 ...
		 2'b10) ?
		  addr___1__h4113 :
		  addr__h4101) ;
  assign addr___1__h4113 = x__h4125 | y__h4126 ;
  assign addr___1__h5197 = x__h5209 | y__h5210 ;
  assign addr__h4101 =
  ...
  assign deburstr_rg_w_beat_count_1_ULT_deburstr_xactor_ETC___d107 =
	     ...
	     deburstr_xactor_from_master_f_wr_addr$D_OUT[28:21] ;
  assign wrap_mask__h4103 =
	     (burst_len__h4102 <<
	      deburstr_xactor_from_master_f_wr_addr$D_OUT[20:18]) -
	     32'd1 ;
  assign wrap_mask__h5187 =
	     (burst_len__h5186 <<
	      deburstr_xactor_from_master_f_rd_addr$D_OUT[20:18]) -
	     32'd1 ;
  assign wrr_bresp__h2016 = core$dma_server_response_get ? 2'b10 : 2'b0 ;
  assign x__h4125 = deburstr_rg_last_beat_waddr & y__h4127 ;
  assign x__h4400 = deburstr_rg_w_beat_count + 8'd1 ;
  assign x__h4907 = deburstr_rg_b_beat_count + 8'd1 ;
  assign x__h5209 = deburstr_rg_last_beat_raddr & y__h5211 ;
  assign x__h5394 = deburstr_rg_ar_beat_count + 8'd1 ;
  assign x__h5613 = deburstr_rg_r_beat_count + 8'd1 ;
  assign y__h4126 = addr__h4101 & wrap_mask__h4103 ;
  assign y__h4127 = ~wrap_mask__h4103 ;
  assign y__h5210 = addr__h5185 & wrap_mask__h5187 ;
  assign y__h5211 = ~wrap_mask__h5187 ;
  ...
  begin
    ...
    v__h809 = v__h815 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
	if (WILL_FIRE_RL_rl_once)
	  $write("%0d: %m.rl_once: PoR to Core: (running ", v__h809);
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
    ...
    v__h1779 = v__h1785 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
	if (WILL_FIRE_RL_loader_adapter_rl_wr_req)
	  $display("%06d:[D]:%m.rl_wr_req", v__h1779);
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
    ...
    v__h2047 = v__h2053 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
	if (WILL_FIRE_RL_loader_adapter_wr_rsp)
	  $display("%06d:[D]:%m.rl_wr_rsp", v__h2047);
    if (RST_N != `BSV_RESET_VALUE)
      if (ndmIfc$OUT_RST != `BSV_RESET_VALUE)
