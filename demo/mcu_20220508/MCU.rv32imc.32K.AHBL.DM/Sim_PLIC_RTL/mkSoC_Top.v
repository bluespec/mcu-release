...
module mkSoC_Top(dmi_reset,
  ...
  wire [31 : 0] plic$fabric_HADDR, plic$fabric_HRDATA, plic$fabric_HWDATA;
  wire [3 : 0] plic$fabric_HPROT;
  wire [2 : 0] plic$fabric_HBURST, plic$fabric_HSIZE;
  wire [1 : 0] plic$fabric_HTRANS;
  wire plic$fabric_HMASTLOCK,
       plic$fabric_HREADY,
       plic$fabric_HREADYOUT,
       plic$fabric_HRESP,
       plic$fabric_HSEL,
       plic$fabric_HWRITE,
  ...
  // submodule ii
  // NOTE: A synthetic interrupt injector to test the PLIC
  mkInterruptInjector ii(.CLK(CLK), .RST_N(RST_N), .irq(ii$irq));
  ...
  // submodule plic
  // NOTE: The Platform Level Interrupt Controller (PLIC)
  mkPLIC_16_1_7 plic(.CLK(CLK),
		     .RST_N(RST_N),
		     .fabric_HADDR(plic$fabric_HADDR),
		     .fabric_HBURST(plic$fabric_HBURST),
		     .fabric_HMASTLOCK(plic$fabric_HMASTLOCK),
		     .fabric_HPROT(plic$fabric_HPROT),
		     .fabric_HREADY(plic$fabric_HREADY),
		     .fabric_HSEL(plic$fabric_HSEL),
		     .fabric_HSIZE(plic$fabric_HSIZE),
		     .fabric_HTRANS(plic$fabric_HTRANS),
		     .fabric_HWDATA(plic$fabric_HWDATA),
		     .fabric_HWRITE(plic$fabric_HWRITE),
		     ...
		     .fabric_HRDATA(plic$fabric_HRDATA),
		     .fabric_HREADYOUT(plic$fabric_HREADYOUT),
		     .fabric_HRESP(plic$fabric_HRESP),
  ...
  assign core$ext_interrupt = plic$v_targets_0_m_eip ;
  assign core$master1_HRDATA = plic$fabric_HRDATA ;
  assign core$master1_HREADY = plic$fabric_HREADYOUT ;
  assign core$master1_HRESP = plic$fabric_HRESP ;
  ...
  // submodule plic
  assign plic$fabric_HADDR = core$master1_HADDR ;
  assign plic$fabric_HBURST = core$master1_HBURST ;
  assign plic$fabric_HMASTLOCK = core$master1_HMASTLOCK ;
  assign plic$fabric_HPROT = core$master1_HPROT ;
  assign plic$fabric_HREADY = 1'd1 ;
  assign plic$fabric_HSEL = 1'd1 ;
  assign plic$fabric_HSIZE = core$master1_HSIZE ;
  assign plic$fabric_HTRANS = core$master1_HTRANS ;
  assign plic$fabric_HWDATA = core$master1_HWDATA ;
  assign plic$fabric_HWRITE = core$master1_HWRITE ;
  assign plic$v_sources_0_m_interrupt_req_set_not_clear = ii$irq[0] ;
  ...
  assign plic$v_sources_1_m_interrupt_req_set_not_clear = ii$irq[1] ;
  assign plic$v_sources_2_m_interrupt_req_set_not_clear = ii$irq[2] ;
  assign plic$v_sources_3_m_interrupt_req_set_not_clear = ii$irq[3] ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d:%m.rl_reset_start_initial ...", v__h3808);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h3879 = v__h3885 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d:%m.rl_reset_complete_initial", v__h3879);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
