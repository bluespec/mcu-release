...
module mkITCM(verbosity,
  ...
  assign MUX_rg_dbg_rsp_valid$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_reset || EN_backdoor_rsp ;
  always@(rg_dbg_f3 or
	  mem$DOB or
  ...
  assign rg_dbg_rsp_valid$EN =
	     WILL_FIRE_RL_rl_reset || EN_backdoor_rsp || EN_backdoor_req ;
  ...
  // submodule mem
  assign mem$ADDRA = imem_req_addr[15:2] ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      EN_backdoor_req: mem$ADDRB = backdoor_req_addr[15:2];
      WILL_FIRE_RL_rl_dbg_write_completion: mem$ADDRB = rg_dbg_addr[15:2];
      EN_dma_req: mem$ADDRB = dma_req_addr[15:2];
      default: mem$ADDRB = 14'b10101010101010 /* unspecified value */ ;
    endcase
  end
