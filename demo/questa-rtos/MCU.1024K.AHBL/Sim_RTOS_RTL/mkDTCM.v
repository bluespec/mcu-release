...
module mkDTCM(verbosity,
  ...
  reg [31 : 0] CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7,
	       CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result259_0_ETC__q8,
	       IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d192,
	       IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d201,
	       _theResult___snd__h4067,
	       mask__h1559,
	       ram_out__h3616,
	       ram_st_value__h3848,
	       y__h1786;
  reg [3 : 0] _theResult___fst__h4066,
	      _theResult___fst__h4099,
	      byte_en__h3847;
  reg CASE_f_reqD_OUT_BITS_65_TO_64_0b0_ld_val_bits_ETC__q9;
  wire [31 : 0] _theResult___snd__h4071,
		_theResult___snd__h4075,
		_theResult___snd__h4100,
		_theResult___snd__h4104,
		data1__h1515,
		data__h2025,
		ld_val_bits__h1384,
		result__h1774,
		...
		result__h5287,
		test_num__h4671;
  wire [15 : 0] memDO_BITS_15_TO_0__q2, memDO_BITS_31_TO_16__q5;
  wire [7 : 0] memDO_BITS_15_TO_8__q3,
	       memDO_BITS_23_TO_16__q4,
	       memDO_BITS_31_TO_24__q6,
	       memDO_BITS_7_TO_0__q1;
  wire [4 : 0] shamt_bits__h2035;
  wire dmem_req_f3_BITS_1_TO_0_30_EQ_0b0_31_OR_dmem_r_ETC___d260,
  ...
  // submodule mem
  BRAM1BELoad #(.FILENAME("/tmp/dtcm.mem"),
		.PIPELINED(1'd0),
		.ADDR_WIDTH(32'd18),
		.DATA_WIDTH(32'd32),
		.CHUNKSIZE(32'd8),
  ...
  assign rg_tohost_value$D_IN =
	     WILL_FIRE_RL_rl_reset ? 32'd0 : ram_st_value__h3848 ;
  ...
  // submodule f_mem_wdata
  assign f_mem_wdata$D_IN = data__h2025 << shamt_bits__h2035 ;
  ...
  always@(WILL_FIRE_RL_mmio_rl_read_rsp or
	  ...
	  WILL_FIRE_RL_mmio_rl_write_req or
	  f_req$D_OUT or WILL_FIRE_RL_rl_tcm_rsp or ram_out__h3616)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_mmio_rl_read_rsp:
	  f_rsp_word32$D_IN = MUX_f_rsp_word32$enq_1__VAL_1;
      WILL_FIRE_RL_mmio_rl_write_req: f_rsp_word32$D_IN = f_req$D_OUT[31:0];
      WILL_FIRE_RL_rl_tcm_rsp: f_rsp_word32$D_IN = ram_out__h3616;
  ...
  // submodule mem
  assign mem$ADDR =
	     MUX_mem$put_1__SEL_1 ? f_req$D_OUT[51:34] : dmem_req_addr[19:2] ;
  assign mem$DI =
	     MUX_mem$put_1__SEL_1 ?
	       ram_st_value__h3848 :
	       32'hAAAAAAAA /* unspecified value */  ;
  assign mem$WE = MUX_mem$put_1__SEL_1 ? byte_en__h3847 : 4'd0 ;
  assign mem$EN =
	     WILL_FIRE_RL_rl_tcm_rsp && f_req$D_OUT[67] && !rg_exc[4] ||
	     EN_dmem_req ;

  // remaining internal signals
  assign _theResult___snd__h4071 = { f_req$D_OUT[23:0], 8'hAA } ;
  assign _theResult___snd__h4075 = { f_req$D_OUT[7:0], 24'hAAAAAA } ;
  assign _theResult___snd__h4100 =
	     (f_req$D_OUT[33:32] == 2'h0) ?
	       f_req$D_OUT[31:0] :
	       _theResult___snd__h4104 ;
  assign _theResult___snd__h4104 = { f_req$D_OUT[15:0], 16'hAAAA } ;
  assign data1__h1515 = f_mem_rdata$D_OUT[31:0] >> shamt_bits__h2035 ;
  assign data__h2025 = f_req$D_OUT[31:0] & mask__h1559 ;
  ...
  assign f_req_first_BIT_67_AND_NOT_rg_exc_18_BIT_4_19__ETC___d172 =
	     ...
	     rg_watch_tohost_56_AND_f_req_first_BITS_63_TO__ETC___d162 &&
	     verbosity != 2'd0 &&
	     ram_st_value__h3848[31:1] == 31'd0 ;
  assign f_req_first_BIT_67_AND_NOT_rg_exc_18_BIT_4_19__ETC___d176 =
	     f_req$D_OUT[67] && !rg_exc[4] &&
	     rg_watch_tohost_56_AND_f_req_first_BITS_63_TO__ETC___d162 &&
	     verbosity != 2'd0 &&
	     ram_st_value__h3848[31:1] != 31'd0 ;
  assign ld_val_bits__h1384 = data1__h1515 & mask__h1559 ;
  assign memDO_BITS_15_TO_0__q2 = mem$DO[15:0] ;
  assign memDO_BITS_15_TO_8__q3 = mem$DO[15:8] ;
  assign memDO_BITS_23_TO_16__q4 = mem$DO[23:16] ;
  assign memDO_BITS_31_TO_16__q5 = mem$DO[31:16] ;
  assign memDO_BITS_31_TO_24__q6 = mem$DO[31:24] ;
  assign memDO_BITS_7_TO_0__q1 = mem$DO[7:0] ;
  assign result__h1774 = ld_val_bits__h1384 | y__h1786 ;
  assign result__h1841 = ld_val_bits__h1384 & mask__h1559 ;
  assign result__h4941 =
	     { {24{memDO_BITS_7_TO_0__q1[7]}}, memDO_BITS_7_TO_0__q1 } ;
  assign result__h4970 =
	     { {24{memDO_BITS_15_TO_8__q3[7]}}, memDO_BITS_15_TO_8__q3 } ;
  assign result__h4998 =
	     { {24{memDO_BITS_23_TO_16__q4[7]}}, memDO_BITS_23_TO_16__q4 } ;
  assign result__h5026 =
	     { {24{memDO_BITS_31_TO_24__q6[7]}}, memDO_BITS_31_TO_24__q6 } ;
  assign result__h5067 = { 24'd0, mem$DO[7:0] } ;
  assign result__h5095 = { 24'd0, mem$DO[15:8] } ;
  assign result__h5123 = { 24'd0, mem$DO[23:16] } ;
  assign result__h5151 = { 24'd0, mem$DO[31:24] } ;
  assign result__h5192 =
	     { {16{memDO_BITS_15_TO_0__q2[15]}}, memDO_BITS_15_TO_0__q2 } ;
  assign result__h5220 =
	     { {16{memDO_BITS_31_TO_16__q5[15]}}, memDO_BITS_31_TO_16__q5 } ;
  assign result__h5259 = { 16'd0, mem$DO[15:0] } ;
  assign result__h5287 = { 16'd0, mem$DO[31:16] } ;
  assign rg_watch_tohost_56_AND_f_req_first_BITS_63_TO__ETC___d162 =
	     rg_watch_tohost && f_req$D_OUT[63:32] == rg_tohost_addr &&
	     ram_st_value__h3848 != 32'd0 ;
  assign shamt_bits__h2035 = { f_req$D_OUT[33:32], 3'b0 } ;
  assign test_num__h4671 = { 1'd0, ram_st_value__h3848[31:1] } ;
  always@(f_req$D_OUT)
  begin
    case (f_req$D_OUT[65:64])
      2'b0: mask__h1559 = 32'h000000FF;
      2'b01: mask__h1559 = 32'h0000FFFF;
      default: mask__h1559 = 32'hFFFFFFFF;
    endcase
  end
  always@(f_req$D_OUT)
  begin
    case (f_req$D_OUT[65:64])
      2'b0: y__h1786 = 32'hFFFFFF00;
      2'b01: y__h1786 = 32'hFFFF0000;
      default: y__h1786 = 32'd0;
    endcase
  end
  always@(f_req$D_OUT)
  begin
    case (f_req$D_OUT[33:32])
      2'h0: _theResult___fst__h4066 = 4'h1;
      2'h1: _theResult___fst__h4066 = 4'h2;
      2'h2: _theResult___fst__h4066 = 4'h4;
      2'h3: _theResult___fst__h4066 = 4'h8;
    endcase
  end
  always@(f_req$D_OUT)
  begin
    case (f_req$D_OUT[33:32])
      2'h0: _theResult___fst__h4099 = 4'h3;
      2'h2: _theResult___fst__h4099 = 4'hC;
      default: _theResult___fst__h4099 = 4'd0;
    endcase
  end
  always@(f_req$D_OUT or
	  _theResult___snd__h4075 or
	  _theResult___snd__h4071 or _theResult___snd__h4104)
  begin
    case (f_req$D_OUT[33:32])
      2'h0: _theResult___snd__h4067 = f_req$D_OUT[31:0];
      2'h1: _theResult___snd__h4067 = _theResult___snd__h4071;
      2'h2: _theResult___snd__h4067 = _theResult___snd__h4104;
      2'd3: _theResult___snd__h4067 = _theResult___snd__h4075;
    endcase
  end
  always@(f_req$D_OUT or _theResult___snd__h4067 or _theResult___snd__h4100)
  begin
    case (f_req$D_OUT[65:64])
      2'b0: ram_st_value__h3848 = _theResult___snd__h4067;
      2'b01: ram_st_value__h3848 = _theResult___snd__h4100;
      default: ram_st_value__h3848 = f_req$D_OUT[31:0];
    endcase
  end
  always@(f_req$D_OUT or _theResult___fst__h4066 or _theResult___fst__h4099)
  begin
    case (f_req$D_OUT[65:64])
      2'b0: byte_en__h3847 = _theResult___fst__h4066;
      2'b01: byte_en__h3847 = _theResult___fst__h4099;
      2'b10, 2'b11: byte_en__h3847 = 4'hF;
    endcase
  end
  always@(f_req$D_OUT or
	  result__h4941 or result__h4970 or result__h4998 or result__h5026)
  begin
    case (f_req$D_OUT[33:32])
      2'h0:
	  IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d192 =
  ...
  always@(f_req$D_OUT or
	  result__h5067 or result__h5095 or result__h5123 or result__h5151)
  begin
    case (f_req$D_OUT[33:32])
      2'h0:
	  IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d201 =
  ...
  always@(f_req$D_OUT or result__h5192 or result__h5220)
  begin
    case (f_req$D_OUT[33:32])
      2'h0:
	  CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7 =
	      result__h5192;
      2'h2:
	  CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7 =
	      result__h5220;
      default: CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7 = 32'd0;
    endcase
  end
  always@(f_req$D_OUT or result__h5259 or result__h5287)
  begin
    case (f_req$D_OUT[33:32])
      2'h0:
	  CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result259_0_ETC__q8 =
	  ...
	  CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result259_0_ETC__q8 =
	      result__h5287;
      default: CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result259_0_ETC__q8 = 32'd0;
    endcase
  end
  always@(f_req$D_OUT or
	  IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d192 or
	  CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7 or
	  mem$DO or
  ...
  begin
    case (f_req$D_OUT[66:64])
	  ...
	  ram_out__h3616 =
	      CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result192_0_ETC__q7;
      3'b010, 3'b011, 3'b110: ram_out__h3616 = mem$DO;
      3'b100:
	  ram_out__h3616 =
	      IF_f_req_first_BITS_33_TO_32_3_EQ_0x0_27_THEN__ETC___d201;
      3'b101:
	  ram_out__h3616 =
	      CASE_f_reqD_OUT_BITS_33_TO_32_0x0_result259_0_ETC__q8;
      3'd7: ram_out__h3616 = 32'd0;
    endcase
  end
  always@(f_req$D_OUT or ld_val_bits__h1384)
  begin
    case (f_req$D_OUT[65:64])
      2'b0:
	  CASE_f_reqD_OUT_BITS_65_TO_64_0b0_ld_val_bits_ETC__q9 =
	      ld_val_bits__h1384[7];
      2'b01:
	  CASE_f_reqD_OUT_BITS_65_TO_64_0b0_ld_val_bits_ETC__q9 =
	      ld_val_bits__h1384[15];
      default: CASE_f_reqD_OUT_BITS_65_TO_64_0b0_ld_val_bits_ETC__q9 =
		   ld_val_bits__h1384[31];
    endcase
  end
  ...
  begin
    ...
    v__h3753 = v__h3759 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tcm_rsp && f_req$D_OUT[67] && !rg_exc[4] &&
	  verbosity != 2'd0)
	$display("%0d: %m.fav_write_to_ram: ST", v__h3753);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tcm_rsp && f_req$D_OUT[67] && !rg_exc[4] &&
	  verbosity != 2'd0)
    ...
    v__h4684 = v__h4690 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tcm_rsp && f_req$D_OUT[67] && !rg_exc[4] &&
	  rg_watch_tohost_56_AND_f_req_first_BITS_63_TO__ETC___d162 &&
	  verbosity != 2'd0)
	$display("%0d: %m.fa_watch_tohost", v__h4684);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tcm_rsp &&
	  f_req_first_BIT_67_AND_NOT_rg_exc_18_BIT_4_19__ETC___d176)
	$write("    FAIL <test_%0d>", test_num__h4671);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_tcm_rsp && f_req$D_OUT[67] && !rg_exc[4] &&
	  rg_watch_tohost_56_AND_f_req_first_BITS_63_TO__ETC___d162 &&
	  verbosity != 2'd0)
